...
template <>
struct DenseMapInfo<CountCopyAndMove> {
    static inline CountCopyAndMove getEmptyKey() {
        return CountCopyAndMove(-1);
    };
...
TEST(DenseSetCustomTest, ReserveTest) {
    ...
    // that is 2/3 of a power of two to stress the grow() condition, and the
    // power
